---
id: 14-COMPUTER-SCIENCE-AND-FULLSTACK-README-MD
title: "14 Computer Science and Full-Stack Mastery"
type: domain-root
status: active
version: 1.0.0
owner: project-maintainer
description: Master domain directory synthesizing the Open Source Society University (OSSU) Computer Science core curriculum with modern industry roadmaps across Full-Stack Architecture, DevOps, AI Engineering, Web3/Solana Systems, and C++ Data Structures & Algorithms.
---
...
```mermaid
flowchart TD
    OSSU["01 OSSU CS Core\n(Intro, Math, Systems, Theory, Security)"]
    DSA["02 DSA & CP in C++\n(22 Core Topics & Algorithms)"]
    WEB["03 Full-Stack Web Architecture\n(TypeScript, React, Next.js, Node, PubSub)"]
    DEVOPS["04 DevOps & Infrastructure\n(Docker, K8s, CI/CD, MicroVM Firecracker)"]
    AI["05 AI Engineering & Autonomous Agents\n(PyTorch, RAG, ReAct Agents, MCP, Evals)"]
    WEB3["06 Web3 & Solana Architecture\n(Cryptography, Rust, Anchor, DeFi, PDAs)"]
