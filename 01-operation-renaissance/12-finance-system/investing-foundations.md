...
Teach an investment-learning and governance process without recommending securities.

## Scope

This document covers goals, horizon, liquidity, risk capacity, uncertainty, fees, diversification, diligence, and decision records. This is general education, not personalized investment, tax, legal, credit, or insurance advice. No return, outcome, or regulatory treatment is guaranteed.
...
Define the learning question, verify authoritative explanations, model scenarios without forecasts, document uncertainty, and pause before irreversible action.
...
A learner compares how fees, liquidity, and concentration affect synthetic scenarios without selecting an investment.
