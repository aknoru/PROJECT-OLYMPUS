...
Provide a neutral framework for documenting obligations and comparing repayment decisions.

## Scope

This document covers balances, rates, fees, due dates, collateral, variable terms, default consequences, and decision records. This is general education, not personalized investment, tax, legal, credit, or insurance advice. No return, outcome, or regulatory treatment is guaranteed.
...
Inventory verified terms, normalize comparison fields, protect minimum obligations, compare lawful options, and obtain qualified help before binding changes.
...
Two synthetic offers are compared using total documented cost, variability, flexibility, and downside conditions.
