...
Maintain a currency-neutral record of money entering, leaving, and remaining available.

## Scope

This document covers income tracking, expense categorization, reconciliation, budgeting, opportunity cost, and review. This is general education, not personalized investment, tax, legal, credit, or insurance advice. No return, outcome, or regulatory treatment is guaranteed.
...
Choose a reporting period, record verified inflows and outflows, reconcile totals, classify essentials and commitments, then decide one adjustment.

For planning, distinguish resources that may support a goal from obligations
that consume future cash flow. This is a decision lens, not a universal
accounting definition. Set goals with an amount or condition, horizon, priority,
funding path, and review trigger; record opportunity cost whenever one goal
displaces another.
...
A synthetic ledger separates recurring commitments from flexible spending and records the trade-off behind a change.
...
- [Finance Scope](scope-and-disclaimer.md)
