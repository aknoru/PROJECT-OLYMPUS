...
Reduce preventable loss through verification, privacy, and incident escalation.

## Scope

This document covers impersonation, urgency, credential theft, payment diversion, document integrity, and reporting pathways. This is general education, not personalized investment, tax, legal, credit, or insurance advice. No return, outcome, or regulatory treatment is guaranteed.
...
Pause unexpected requests, verify through an independent channel, protect credentials, preserve evidence, contact relevant providers, and use current local reporting routes.
...
An unexpected payment request is verified using a previously known contact method rather than the message link.
