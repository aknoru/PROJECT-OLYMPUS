...
Plan a configurable reserve for unexpected financial disruption.

## Scope

This document covers goal definition, eligible uses, access needs, replenishment, and review triggers. This is general education, not personalized investment, tax, legal, credit, or insurance advice. No return, outcome, or regulatory treatment is guaranteed.
...
Define covered events and essential-cost basis, choose a locally appropriate target with qualified input where needed, separate the reserve, and review after use.
...
A synthetic plan defines job interruption as an eligible event and records a staged replenishment decision.
