...
Support risk-transfer literacy without recommending a product or coverage level.

## Scope

This document covers exposure inventory, policy terms, exclusions, limits, deductibles, claims process, and review. This is general education, not personalized investment, tax, legal, credit, or insurance advice. No return, outcome, or regulatory treatment is guaranteed.
...
Identify material exposures, distinguish retention from transfer, read current documents, compare like-for-like terms, and seek licensed advice when required.
...
A synthetic policy review discovers an exclusion and records a question for an authorized adviser.
