...
Provide a configurable response to severe academic or semester disruption.

## Scope

This protocol covers current academic evidence, deadlines, institutional options, prerequisite gaps, capacity, stakeholder communication, and decision records. It is a systems-engineering control, not
...
Verify current facts and official options, check health and safety, identify binding deadlines, contact authorized institutional support, preserve essential obligations, and create a capacity-tested plan.
...
A semester setback is documented with current institutional information and a reduced prerequisite-first plan; no outcome is promised.
...
- [Study Assessment](../04-study-system/assessment-protocol.md)
