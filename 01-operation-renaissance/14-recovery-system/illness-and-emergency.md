...
Protect safety and continuity when health, care, or emergency conditions disrupt execution.

## Scope

This protocol covers load suspension, local emergency pathways, professional-care boundaries, communication, privacy, evidence preservation, and return-to-work gating. It is a systems-engineering control, not
...
Prioritize immediate safety, contact appropriate local emergency or qualified professional support, suspend nonessential work, communicate minimum necessary information, and resume only from observed capacity.
...
During illness, deadlines are renegotiated and nonessential work is paused; this repository does not determine diagnosis, treatment, or return-to-activity timing.
