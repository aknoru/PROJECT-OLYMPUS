...
Rebaseline after several disrupted days or a lost weekly cycle.

## Scope

This protocol covers capacity loss, commitments, deadlines, dependencies, minimum viable continuity, and stakeholder communication. It is a systems-engineering control, not
...
Stop catch-up assumptions, quantify current capacity, triage obligations, renegotiate or remove scope, rebuild one bounded week, and verify stability before increasing load.
...
A lost week leads to milestone resequencing and explicit scope removal rather than doubling the next week's workload.
...
- [Weekly Review](../13-review-system/weekly-review.md)
