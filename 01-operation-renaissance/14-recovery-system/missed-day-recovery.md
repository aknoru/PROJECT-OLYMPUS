...
Recover from one disrupted day without unsafe schedule compression or automatic backlog transfer.

## Scope

This protocol covers closure, cause classification, minimum continuity, task disposition, next-day capacity, and recurrence signals. It is a systems-engineering control, not
...
Close the missed day, protect safety and obligations, delete, reduce, reschedule, or escalate each item, choose one restart action, and review after the next operating day.
...
A missed practice block is reduced to one prerequisite check and rescheduled within available capacity.
...
- [Daily Close](../13-review-system/daily-close.md)
