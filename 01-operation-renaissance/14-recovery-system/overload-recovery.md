...
Reduce excessive demand and restore sustainable execution without diagnosing burnout.

## Scope

This protocol covers demand inventory, work-in-progress, capacity, fatigue and stress observations, commitments, support, and professional escalation. It is a systems-engineering control, not
...
Check safety, stop load growth, inventory demands, remove or defer low-value work, reduce work in progress, protect recovery capacity, and verify trends before expansion.
...
Persistent exhaustion and impaired function trigger workload reduction and qualified support, not a productivity technique or self-diagnosis.
