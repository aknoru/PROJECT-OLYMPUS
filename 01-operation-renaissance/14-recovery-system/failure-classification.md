...
Classify disruption by safety, duration, cause, system, and consequence before selecting recovery action.

## Scope

This protocol covers missed work, poor mock tests, semester setbacks, placement rejection, project failure, illness, overload, and mixed events. It is a systems-engineering control, not
...
Freeze automatic carryover, record observations, check safety, classify the affected system and duration, identify controllable causes, select a protocol, and schedule reassessment.
...
A poor mock score is separated into knowledge, timing, execution, and review-process evidence; a placement rejection remains an external outcome unless process evidence supports a change.
