...
Contain project failure, preserve evidence, and decide repair, reduce, restart, transfer, or stop.

## Scope

This protocol covers requirements, test evidence, defects, dependencies, safety, resources, stakeholder impact, and learning artifacts. It is a systems-engineering control, not
...
Stop unsafe operation, preserve logs and versions, reproduce the failure where safe, classify root causes, assess option cost, record a decision, and verify corrective action.
...
A failed demonstration is traced to an untested interface; the corrective action adds an interface test with an owner and due date.
