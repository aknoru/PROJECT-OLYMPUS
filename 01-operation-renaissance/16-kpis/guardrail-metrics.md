...
Define measures that constrain load and trigger review before optimization causes harm.

## Scope

This document covers health capacity, privacy, quality, safety, financial stress, overload, error escape, and risk exposure. Metric definitions live in the canonical registry; observations remain in approved source records. It does not hardcode personal goals,
...
Define the protected constraint, choose a minimal observation, specify private storage and coverage, configure escalation bands with qualified input where needed, and prioritize the guardrail over throughput.
...
A private fatigue trend can trigger load review without publishing raw health data or diagnosing a condition.
