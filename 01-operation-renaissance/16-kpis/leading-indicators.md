...
Define measures of controllable actions without treating activity as capability or outcomes.

## Scope

This document covers execution, learning, project, research, finance, health, and recovery actions that precede evidence. Metric definitions live in the canonical registry; observations remain in approved source records. It does not hardcode personal goals,
...
Map an action to an objective, require a quality check, define source and cadence, configure a decision band, monitor gaming risk, and retire measures that do not affect decisions.
...
Reviewed problem attempts may be a candidate leading measure only when correctness and review completion prevent volume gaming.
