...
Define the required schema and lifecycle for every approved metric.

## Scope

This document covers stable IDs, names, questions, formulas, units, sources, cadence, aggregation, quality, bands, actions, owners, privacy, and review. Metric definitions live in the canonical registry; observations remain in approved source records. It does not hardcode personal goals,
...
Draft the full definition, validate units and edge cases, link the canonical source, configure thresholds, review behavior and privacy risks, register approval, and version changes.
...
A synthetic metric definition states numerator, denominator, missing-data rule, owner, action, and review date but leaves its target band configurable.
