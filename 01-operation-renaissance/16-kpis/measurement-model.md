...
Connect objectives, controllable actions, evidence, measures, reviews, and decisions.

## Scope

This document covers leading, evidence, lagging, guardrail, risk, execution, learning, project, research, health, finance, and recovery measurement classes. Metric definitions live in the canonical registry; observations remain in approved source records. It does not hardcode personal goals,
...
State the decision question, select the smallest valid metric class, define observation and quality contracts, configure thresholds outside the document, test behavior, and approve through review.
...
A recovery measure records restart stability for a configured review window without defining a universal recovery speed.
