...
Rebaseline the campaign at its midpoint without concealing drift.

## Scope

This document covers objective validity, evidence, capability, capacity, risks, opportunity cost, and remaining runway. The review evaluates evidence and process; it does not convert inference into fact or external outcomes into personal worth.
...
Audit the first half, compare assumptions with observations, stop low-value work, reallocate bounded capacity, and document revised commitments.
...
A goal with weak evidence but high cost is narrowed to preserve higher-value work.
