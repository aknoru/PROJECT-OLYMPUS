...
Close the execution loop with a brief evidence-based review.

## Scope

This document covers planned work, completed evidence, blockers, capacity, carryover, and first next action. The review evaluates evidence and process; it does not convert inference into fact or external outcomes into personal worth.
...
Compare plan to evidence, close or classify open work, record one lesson, choose the first next action, and stop.
...
An unfinished task is reduced and rescheduled instead of automatically rolled forward.
