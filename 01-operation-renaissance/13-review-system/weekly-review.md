...
Evaluate a week and configure the next one from evidence.

## Scope

This document covers outcomes, execution audit, goal tracking, habits, capacity, risks, and corrective action. The review evaluates evidence and process; it does not convert inference into fact or external outcomes into personal worth.
...
Assemble daily closes, audit planned versus observed work, identify causes, select at most three outcomes, reserve buffer, and assign actions.
...
Repeated interruption data leads to fewer active commitments and a protected work block.
