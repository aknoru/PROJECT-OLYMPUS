...
Learn from a bounded event without blame or hindsight distortion.

## Scope

This document covers expected result, observed result, contributing conditions, decisions, lessons, and corrective actions. The review evaluates evidence and process; it does not convert inference into fact or external outcomes into personal worth.
...
State the prior intent, reconstruct evidence, compare expected and observed results, identify system causes, assign corrective action, and verify effectiveness.
...
A failed demonstration produces a reproducibility checklist change with an owner and due date.
