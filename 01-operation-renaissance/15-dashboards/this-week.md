...
Show weekly outcomes, capacity, risks, and decision readiness.

## Scope

This document covers weekly outcomes, deliverables, planned and observed capacity, review status, buffer, blockers, and evidence. Dashboards are derived views and never own source data. It does not hardcode personal goals,
...
Read the weekly plan and daily closes, validate coverage, show no more than eight primary measures, identify trend direction, and route the weekly review.
...
Repeated carryover is shown with its evidence coverage and routes to weekly replanning rather than a red score alone.
