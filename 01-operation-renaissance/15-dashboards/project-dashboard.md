...
Show project lifecycle, verification, risk, and portfolio readiness.

## Scope

This document covers active-project limits, gate state, requirements, tests, defects, risks, documentation, demo, and release evidence. Dashboards are derived views and never own source data. It does not hardcode personal goals,
...
Read the project registry and canonical artifacts, validate gate evidence, show requirement and test coverage with warnings, and route the next review gate.
...
A demo exists, but missing acceptance-test evidence keeps portfolio readiness at blocked.
