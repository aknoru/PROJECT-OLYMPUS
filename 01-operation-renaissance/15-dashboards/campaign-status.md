...
Provide campaign, monthly, and phase-level visibility from canonical plans and reviews.

## Scope

This document covers campaign objectives, phase evidence, monthly reviews, capability trends, research, finance, recovery, milestones, and unresolved decisions. Dashboards are derived views and never own source data. It does not hardcode personal goals,
...
Resolve the configured reporting period, aggregate approved summaries, preserve uncertainty, compare evidence with configured bands, and route phase or monthly decisions.
...
The monthly section reports a missing research review as insufficient-data and links to the source record.
...
- [Monthly Review](../13-review-system/monthly-review.md)
