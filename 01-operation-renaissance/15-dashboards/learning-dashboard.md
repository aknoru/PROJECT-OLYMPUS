...
Show learning evidence and adaptation needs without equating activity with mastery.

## Scope

This document covers curriculum objectives, recall, problem solving, transfer, assessment, error recurrence, review coverage, and evidence freshness. Dashboards are derived views and never own source data. It does not hardcode personal goals,
...
Read canonical assessment and error records, separate practice volume from demonstrated capability, summarize configured mastery evidence, and route reassessment.
...
High practice volume with recurring errors is shown as at-risk rather than on-track.
