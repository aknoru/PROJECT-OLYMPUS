---
id: REN-DASH-10
title: "Health Capacity Dashboard"
...
# Health Capacity Dashboard

## Purpose

Show private, minimal guardrail trends that constrain workload without diagnosis.

## Scope

This document covers capacity, sleep opportunity, fatigue observations, activity continuity, stress signals, privacy, and escalation state. Dashboards are derived views and never own source data. It does not hardcode personal goals,
...
Read only consented private summaries, validate minimum coverage, avoid clinical interpretation, surface guardrail exceptions, and route load reduction or professional support.
...
A persistent capacity decline triggers workload review; the dashboard does not name a condition or recommend treatment.
