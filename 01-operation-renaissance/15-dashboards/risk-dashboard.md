...
Aggregate current campaign risks, including research, finance, recovery, and cross-system dependencies.

## Scope

This document covers risk statements, causes, consequences, likelihood and impact scales, owners, mitigations, triggers, residual risk, and evidence freshness. Dashboards are derived views and never own source data. It does not hardcode personal goals,
...
Read canonical risk and decision records, validate owners and review dates, rank only with configured scales, show overdue mitigations, and route escalation.
...
A finance-related risk appears with a verified source, owner, mitigation, and review date—not a fabricated monetary threshold.
